...
btnAlexicale.setBackground(Color.GRAY);
        //(UIManager.getColor("Button.foreground"));
...
btnAsyntaxique.setBackground(Color.GRAY);
        //(UIManager.getColor("Button.foreground"));
...
btnAsmantique.setBackground(Color.GRAY);//(UIManager.getColor("Button.foreground"));
